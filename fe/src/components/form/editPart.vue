...
const formData = reactive({
  partId: props.selectedItem.partId,
  customer: props.selectedItem.customer,
  partType: props.selectedItem.partType,
  partName: props.selectedItem.partName,
  partNumber: props.selectedItem.partNumber,
  thickness: props.selectedItem.thickness,
  width: props.selectedItem.width,
  length: props.selectedItem.length,
  sg: props.selectedItem.sg,
  headers: props.selectedItem.headers,
  kneadingType: props.selectedItem.kneadingType,
  kneadingItems: props.selectedItem.kneadingItems,
  heaterCheck: props.selectedItem.heaterCheck == 1 ? true : false,
  extrudingType: props.selectedItem.extrudingType,
  extrudingItems: props.selectedItem.extrudingItems,
  pressOn: props.selectedItem.pressOn == 1 ? true : false,
  pressItems: props.selectedItem.pressItems,
  outgoingOn: props.selectedItem.outgoingOn == 1 ? true : false,
  outgoingItems: props.selectedItem.outgoingItems,
  partDrawing: null,
  actImage: null,
  extAppStd: props.selectedItem.extAppStd,
});
...
const refresh = async () => {
  ...
  partDrawingUrl.value = images.drw;
